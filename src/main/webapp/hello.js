...
function enableButtons () {
	...
	btn.value="Click me for greeting by period";
	
	btn = document.getElementById("input_calculate");
	btn.onclick=function(){calculate();};
	
	
	btn.value="Click me for substraction";
}
...
function calculate(){
	var first = document.getElementById("first_button").value;
	var second = document.getElementById("second_button").value; 
	var request = gapi.client.helloworldendpoints.calculate({'first': first, 'second':second});
	request.execute(sayHelloCallback);
	}
